...
/* tme13/display: */
typedef enum kcg_tag_SSM_TR_display {
  SSM_TR_no_trans_display,
  SSM_TR_DisplayClock_DisplayTime_1_DisplayClock_display,
  SSM_TR_DisplayTime_DisplayClock_1_DisplayTime_display
} SSM_TR_display;
/* tme13/display: */
typedef enum kcg_tag_SSM_ST_display {
  SSM_st_DisplayClock_display,
  SSM_st_DisplayTime_display
} SSM_ST_display;
/* tme13/chrono: */
typedef enum kcg_tag_SSM_TR_chrono {
  SSM_TR_no_trans_chrono,
  SSM_TR_Pause_Run_1_Pause_chrono,
  SSM_TR_Pause_Pause_2_Pause_chrono,
  SSM_TR_Run_Pause_1_Run_chrono
} SSM_TR_chrono;
/* tme13/chrono: */
typedef enum kcg_tag_SSM_ST_chrono {
  SSM_st_Pause_chrono,
  SSM_st_Run_chrono
} SSM_ST_chrono;
