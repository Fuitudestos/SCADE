...
#ifdef __cplusplus
  #ifdef pSimarray_int64_3VTable_defined
    extern struct SimTypeVTable *pSimarray_int64_3VTable;
  #else 
    struct SimTypeVTable *pSimarray_int64_3VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_int64_3VTable;
#endif

int array_int64_3_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_int64_3VTable != NULL
        && pSimarray_int64_3VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_int64_3VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, kcg_int64_to_string, 3, sizeof(kcg_int64), pfnStrAppend, pStrObj);
}

int check_array_int64_3_string(const char *str, char **endptr)
{
    static array_int64_3 rTemp;
    return string_to_array_int64_3(str, &rTemp, endptr);
}

int string_to_array_int64_3(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_int64_3VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_int64_3VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_kcg_int64_Utils, 3, sizeof(kcg_int64), endptr);
    }
    return nRet;
}

int is_array_int64_3_double_conversion_allowed()
{
    if (pSimarray_int64_3VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_int64_3VTable);
    }
    return 0;
}

int array_int64_3_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_int64_3VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_int64_3VTable, nValue);
    }
    return 0;
}

int is_array_int64_3_long_conversion_allowed()
{
    if (pSimarray_int64_3VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_int64_3VTable);
    }
    return 0;
}

int array_int64_3_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_int64_3VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_int64_3VTable, nValue);
    }
    return 0;
}

void compare_array_int64_3(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_int64_3VTable != NULL
        && pSimarray_int64_3VTable->m_version >= Scv612
        && pSimarray_int64_3VTable->m_pfnCompare != NULL) {
        if (pSimarray_int64_3VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_int64_3VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_int64_3VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_kcg_int64, 3, sizeof(kcg_int64), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_int64_3_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_kcg_int64_signature, 3, pfnStrAppend, pStrObj); 
}

int set_array_int64_3_default_value(void *pValue)
{
    int i;
    for (i = 0; i < 3; i++)
        set_kcg_int64_default_value(&((kcg_int64*)pValue)[i]);
    return 1;
}

int init_array_int64_3(void *pValue)
{
    return 1;
}

int release_array_int64_3(void *pValue)
{
    return 1;
}

int copy_array_int64_3(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_int64_3((array_int64_3*)pToValue, (array_int64_3*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_int64_3_Utils = {
    array_int64_3_to_string,
    check_array_int64_3_string,
    string_to_array_int64_3,
    is_array_int64_3_double_conversion_allowed,
    array_int64_3_to_double,
    is_array_int64_3_long_conversion_allowed,
    array_int64_3_to_long,
    compare_array_int64_3,
    get_array_int64_3_signature,
    set_array_int64_3_default_value,
    init_array_int64_3,
    release_array_int64_3,
    copy_array_int64_3,
    sizeof(array_int64_3)
};
...
#ifdef __cplusplus
  #ifdef pSimarray_int64_4VTable_defined
    extern struct SimTypeVTable *pSimarray_int64_4VTable;
  #else 
    struct SimTypeVTable *pSimarray_int64_4VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_int64_4VTable;
#endif

int array_int64_4_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_int64_4VTable != NULL
        && pSimarray_int64_4VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_int64_4VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, kcg_int64_to_string, 4, sizeof(kcg_int64), pfnStrAppend, pStrObj);
}

int check_array_int64_4_string(const char *str, char **endptr)
{
    static array_int64_4 rTemp;
    return string_to_array_int64_4(str, &rTemp, endptr);
}

int string_to_array_int64_4(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_int64_4VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_int64_4VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_kcg_int64_Utils, 4, sizeof(kcg_int64), endptr);
    }
    return nRet;
}

int is_array_int64_4_double_conversion_allowed()
{
    if (pSimarray_int64_4VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_int64_4VTable);
    }
    return 0;
}

int array_int64_4_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_int64_4VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_int64_4VTable, nValue);
    }
    return 0;
}

int is_array_int64_4_long_conversion_allowed()
{
    if (pSimarray_int64_4VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_int64_4VTable);
    }
    return 0;
}

int array_int64_4_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_int64_4VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_int64_4VTable, nValue);
    }
    return 0;
}

void compare_array_int64_4(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_int64_4VTable != NULL
        && pSimarray_int64_4VTable->m_version >= Scv612
        && pSimarray_int64_4VTable->m_pfnCompare != NULL) {
        if (pSimarray_int64_4VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_int64_4VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_int64_4VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_kcg_int64, 4, sizeof(kcg_int64), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_int64_4_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_kcg_int64_signature, 4, pfnStrAppend, pStrObj); 
}

int set_array_int64_4_default_value(void *pValue)
{
    int i;
    for (i = 0; i < 4; i++)
        set_kcg_int64_default_value(&((kcg_int64*)pValue)[i]);
...
int init_array_int64_4(void *pValue)
{
    return 1;
}

int release_array_int64_4(void *pValue)
{
    return 1;
}

int copy_array_int64_4(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_int64_4((array_int64_4*)pToValue, (array_int64_4*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_int64_4_Utils = {
    array_int64_4_to_string,
    check_array_int64_4_string,
    string_to_array_int64_4,
    is_array_int64_4_double_conversion_allowed,
    array_int64_4_to_double,
    is_array_int64_4_long_conversion_allowed,
    array_int64_4_to_long,
    compare_array_int64_4,
    get_array_int64_4_signature,
    set_array_int64_4_default_value,
    init_array_int64_4,
    release_array_int64_4,
    copy_array_int64_4,
    sizeof(array_int64_4)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_ST_chronoVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_chronoVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_chronoVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_chronoVTable;
#endif

static SimEnumValUtils SSM_ST_chrono_values[] = {
    { "Pause", SSM_st_Pause_chrono},
    { "Pause", SSM_st_Pause_chrono},
    { "Run", SSM_st_Run_chrono},
    { "Run", SSM_st_Run_chrono},
};
const int SSM_ST_chrono_nb_values = 4;

int SSM_ST_chrono_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_chronoVTable != NULL
        && pSimSSM_ST_chronoVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_chronoVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_chrono*)pValue, SSM_ST_chrono_values, SSM_ST_chrono_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_chrono_string(const char *str, char **endptr)
{
    static SSM_ST_chrono rTemp;
    return string_to_SSM_ST_chrono(str, &rTemp, endptr);
}

int string_to_SSM_ST_chrono(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_chronoVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_chronoVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_chrono_values, SSM_ST_chrono_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_chrono*)pValue = (SSM_ST_chrono)nTemp;
    }
    return nRet;
}

int is_SSM_ST_chrono_double_conversion_allowed()
{
    if (pSimSSM_ST_chronoVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_chronoVTable);
    }
    return 1;
}

int SSM_ST_chrono_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_chronoVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_chronoVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_chrono*)pValue);
    return 1;
}

int is_SSM_ST_chrono_long_conversion_allowed()
{
    if (pSimSSM_ST_chronoVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_chronoVTable);
    }
    return 1;
}

int SSM_ST_chrono_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_chronoVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_chronoVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_chrono*)pValue);
    return 1;
}

void compare_SSM_ST_chrono(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_chronoVTable != NULL
        && pSimSSM_ST_chronoVTable->m_version >= Scv612
        && pSimSSM_ST_chronoVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_chronoVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_chronoVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_chronoVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_chrono*)pValue1), (int)(*(SSM_ST_chrono*)pValue2));
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_SSM_ST_chrono_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_chrono_values, SSM_ST_chrono_nb_values, pfnStrAppend, pStrObj);
}

int set_SSM_ST_chrono_default_value(void *pValue)
{
    *(SSM_ST_chrono*)pValue = SSM_st_Pause_chrono;
    return 1;
}

int init_SSM_ST_chrono(void *pValue)
{
    return 1;
}

int release_SSM_ST_chrono(void *pValue)
{
    return 1;
}

int copy_SSM_ST_chrono(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_chrono*)pToValue) = *((SSM_ST_chrono*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_chrono_Utils = {
    SSM_ST_chrono_to_string,
    check_SSM_ST_chrono_string,
    string_to_SSM_ST_chrono,
    is_SSM_ST_chrono_double_conversion_allowed,
    SSM_ST_chrono_to_double,
    is_SSM_ST_chrono_long_conversion_allowed,
    SSM_ST_chrono_to_long,
    compare_SSM_ST_chrono,
    get_SSM_ST_chrono_signature,
    set_SSM_ST_chrono_default_value,
    init_SSM_ST_chrono,
    release_SSM_ST_chrono,
    copy_SSM_ST_chrono,
    sizeof(SSM_ST_chrono)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_ST_displayVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_displayVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_displayVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_displayVTable;
#endif

static SimEnumValUtils SSM_ST_display_values[] = {
    { "DisplayClock", SSM_st_DisplayClock_display},
    { "DisplayClock", SSM_st_DisplayClock_display},
    { "DisplayTime", SSM_st_DisplayTime_display},
    { "DisplayTime", SSM_st_DisplayTime_display},
};
const int SSM_ST_display_nb_values = 4;

int SSM_ST_display_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_displayVTable != NULL
        && pSimSSM_ST_displayVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_displayVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_display*)pValue, SSM_ST_display_values, SSM_ST_display_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_display_string(const char *str, char **endptr)
{
    static SSM_ST_display rTemp;
    return string_to_SSM_ST_display(str, &rTemp, endptr);
}

int string_to_SSM_ST_display(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_displayVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_displayVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_display_values, SSM_ST_display_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_display*)pValue = (SSM_ST_display)nTemp;
    }
    return nRet;
}

int is_SSM_ST_display_double_conversion_allowed()
{
    if (pSimSSM_ST_displayVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_displayVTable);
    }
    return 1;
}

int SSM_ST_display_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_displayVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_displayVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_display*)pValue);
    return 1;
}

int is_SSM_ST_display_long_conversion_allowed()
{
    if (pSimSSM_ST_displayVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_displayVTable);
    }
    return 1;
}

int SSM_ST_display_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_displayVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_displayVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_display*)pValue);
    return 1;
}

void compare_SSM_ST_display(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_displayVTable != NULL
        && pSimSSM_ST_displayVTable->m_version >= Scv612
        && pSimSSM_ST_displayVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_displayVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_displayVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_displayVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_display*)pValue1), (int)(*(SSM_ST_display*)pValue2));
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_SSM_ST_display_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_display_values, SSM_ST_display_nb_values, pfnStrAppend, pStrObj);
}

int set_SSM_ST_display_default_value(void *pValue)
{
    *(SSM_ST_display*)pValue = SSM_st_DisplayClock_display;
    return 1;
}

int init_SSM_ST_display(void *pValue)
{
    return 1;
}

int release_SSM_ST_display(void *pValue)
{
    return 1;
}

int copy_SSM_ST_display(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_display*)pToValue) = *((SSM_ST_display*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_display_Utils = {
    SSM_ST_display_to_string,
    check_SSM_ST_display_string,
    string_to_SSM_ST_display,
    is_SSM_ST_display_double_conversion_allowed,
    SSM_ST_display_to_double,
    is_SSM_ST_display_long_conversion_allowed,
    SSM_ST_display_to_long,
    compare_SSM_ST_display,
    get_SSM_ST_display_signature,
    set_SSM_ST_display_default_value,
    init_SSM_ST_display,
    release_SSM_ST_display,
    copy_SSM_ST_display,
    sizeof(SSM_ST_display)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_TR_chronoVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_chronoVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_chronoVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_chronoVTable;
#endif

static SimEnumValUtils SSM_TR_chrono_values[] = {
    { "SSM_TR_no_trans_chrono", SSM_TR_no_trans_chrono},
    { "SSM_TR_no_trans_chrono", SSM_TR_no_trans_chrono},
    { "SSM_TR_Pause_Run_1_Pause_chrono", SSM_TR_Pause_Run_1_Pause_chrono},
    { "SSM_TR_Pause_Run_1_Pause_chrono", SSM_TR_Pause_Run_1_Pause_chrono},
    { "SSM_TR_Pause_Pause_2_Pause_chrono", SSM_TR_Pause_Pause_2_Pause_chrono},
    { "SSM_TR_Pause_Pause_2_Pause_chrono", SSM_TR_Pause_Pause_2_Pause_chrono},
    { "SSM_TR_Run_Pause_1_Run_chrono", SSM_TR_Run_Pause_1_Run_chrono},
    { "SSM_TR_Run_Pause_1_Run_chrono", SSM_TR_Run_Pause_1_Run_chrono},
};
const int SSM_TR_chrono_nb_values = 8;

int SSM_TR_chrono_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_chronoVTable != NULL
        && pSimSSM_TR_chronoVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_chronoVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_chrono*)pValue, SSM_TR_chrono_values, SSM_TR_chrono_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_chrono_string(const char *str, char **endptr)
{
    static SSM_TR_chrono rTemp;
    return string_to_SSM_TR_chrono(str, &rTemp, endptr);
}

int string_to_SSM_TR_chrono(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_chronoVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_chronoVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_chrono_values, SSM_TR_chrono_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_chrono*)pValue = (SSM_TR_chrono)nTemp;
    }
    return nRet;
}

int is_SSM_TR_chrono_double_conversion_allowed()
{
    if (pSimSSM_TR_chronoVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_chronoVTable);
    }
    return 1;
}

int SSM_TR_chrono_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_chronoVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_chronoVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_chrono*)pValue);
    return 1;
}

int is_SSM_TR_chrono_long_conversion_allowed()
{
    if (pSimSSM_TR_chronoVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_chronoVTable);
    }
    return 1;
}

int SSM_TR_chrono_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_chronoVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_chronoVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_chrono*)pValue);
    return 1;
}

void compare_SSM_TR_chrono(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_chronoVTable != NULL
        && pSimSSM_TR_chronoVTable->m_version >= Scv612
        && pSimSSM_TR_chronoVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_chronoVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_chronoVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_chronoVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_chrono*)pValue1), (int)(*(SSM_TR_chrono*)pValue2));
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_SSM_TR_chrono_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_chrono_values, SSM_TR_chrono_nb_values, pfnStrAppend, pStrObj);
}

int set_SSM_TR_chrono_default_value(void *pValue)
{
    *(SSM_TR_chrono*)pValue = SSM_TR_no_trans_chrono;
    return 1;
}

int init_SSM_TR_chrono(void *pValue)
{
    return 1;
}

int release_SSM_TR_chrono(void *pValue)
{
    return 1;
}

int copy_SSM_TR_chrono(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_chrono*)pToValue) = *((SSM_TR_chrono*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_chrono_Utils = {
    SSM_TR_chrono_to_string,
    check_SSM_TR_chrono_string,
    string_to_SSM_TR_chrono,
    is_SSM_TR_chrono_double_conversion_allowed,
    SSM_TR_chrono_to_double,
    is_SSM_TR_chrono_long_conversion_allowed,
    SSM_TR_chrono_to_long,
    compare_SSM_TR_chrono,
    get_SSM_TR_chrono_signature,
    set_SSM_TR_chrono_default_value,
    init_SSM_TR_chrono,
    release_SSM_TR_chrono,
    copy_SSM_TR_chrono,
    sizeof(SSM_TR_chrono)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_TR_displayVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_displayVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_displayVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_displayVTable;
#endif

static SimEnumValUtils SSM_TR_display_values[] = {
    { "SSM_TR_no_trans_display", SSM_TR_no_trans_display},
    { "SSM_TR_no_trans_display", SSM_TR_no_trans_display},
    { "SSM_TR_DisplayClock_DisplayTime_1_DisplayClock_display", SSM_TR_DisplayClock_DisplayTime_1_DisplayClock_display},
    { "SSM_TR_DisplayClock_DisplayTime_1_DisplayClock_display", SSM_TR_DisplayClock_DisplayTime_1_DisplayClock_display},
    { "SSM_TR_DisplayTime_DisplayClock_1_DisplayTime_display", SSM_TR_DisplayTime_DisplayClock_1_DisplayTime_display},
    { "SSM_TR_DisplayTime_DisplayClock_1_DisplayTime_display", SSM_TR_DisplayTime_DisplayClock_1_DisplayTime_display},
};
const int SSM_TR_display_nb_values = 6;

int SSM_TR_display_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_displayVTable != NULL
        && pSimSSM_TR_displayVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_displayVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_display*)pValue, SSM_TR_display_values, SSM_TR_display_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_display_string(const char *str, char **endptr)
{
    static SSM_TR_display rTemp;
    return string_to_SSM_TR_display(str, &rTemp, endptr);
}

int string_to_SSM_TR_display(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_displayVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_displayVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_display_values, SSM_TR_display_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_display*)pValue = (SSM_TR_display)nTemp;
    }
    return nRet;
}

int is_SSM_TR_display_double_conversion_allowed()
{
    if (pSimSSM_TR_displayVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_displayVTable);
    }
    return 1;
}

int SSM_TR_display_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_displayVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_displayVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_display*)pValue);
    return 1;
}

int is_SSM_TR_display_long_conversion_allowed()
{
    if (pSimSSM_TR_displayVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_displayVTable);
    }
    return 1;
}

int SSM_TR_display_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_displayVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_displayVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_display*)pValue);
    return 1;
}

void compare_SSM_TR_display(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_displayVTable != NULL
        && pSimSSM_TR_displayVTable->m_version >= Scv612
        && pSimSSM_TR_displayVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_displayVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_displayVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_displayVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_display*)pValue1), (int)(*(SSM_TR_display*)pValue2));
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_SSM_TR_display_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_display_values, SSM_TR_display_nb_values, pfnStrAppend, pStrObj);
}

int set_SSM_TR_display_default_value(void *pValue)
{
    *(SSM_TR_display*)pValue = SSM_TR_no_trans_display;
    return 1;
}

int init_SSM_TR_display(void *pValue)
{
    return 1;
}

int release_SSM_TR_display(void *pValue)
{
    return 1;
}

int copy_SSM_TR_display(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_display*)pToValue) = *((SSM_TR_display*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_display_Utils = {
    SSM_TR_display_to_string,
    check_SSM_TR_display_string,
    string_to_SSM_TR_display,
    is_SSM_TR_display_double_conversion_allowed,
    SSM_TR_display_to_double,
    is_SSM_TR_display_long_conversion_allowed,
    SSM_TR_display_to_long,
    compare_SSM_TR_display,
    get_SSM_TR_display_signature,
    set_SSM_TR_display_default_value,
    init_SSM_TR_display,
    release_SSM_TR_display,
    copy_SSM_TR_display,
    sizeof(SSM_TR_display)
};
